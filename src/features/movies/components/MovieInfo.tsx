        ...
        <div className="grid grid-cols-1 md:grid-cols-[280px_1fr] gap-6 md:gap-12 items-start">
            ...
            {movie.ageRestriction}
                    ...
                    <div className="flex items-center gap-1.5 text-description-light dark:text-description-dark">
                        <ClockIcon />
                        <span className="text-[15px] font-medium font-montserrat">{movie.duration} хв</span>
                    </div>

                    <div className="flex items-center gap-1.5 text-description-light dark:text-description-dark">
                        <CalendarIcon />
                        <span className="text-[15px] font-medium font-montserrat">{movie.year}</span>
                    </div>
                </div>
              ...
              {g}
                ...
                <div className={clsx(
                    ...
                    <CalendarIcon />
                    У прокаті до {endDateFormatted} р.
                </div>
            </div>
        </div>
    );
