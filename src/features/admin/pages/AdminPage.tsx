        ...
        <div className="max-w-4xl mx-auto relative">
                ...
                {isCalendarOpen && (
                    <div className="absolute top-full left-[180px] mt-4 z-50 bg-[#1A1A1F] border border-gray-800 rounded-[24px] p-6 shadow-[0_20px_50px_rgba(0,0,0,0.5)] w-[320px] backdrop-blur-md">
                        <div className="flex justify-between items-center mb-6 px-2 text-white">
                            ...
                            <span className="font-semibold tracking-wide">February 2026</span>
                            <button className="text-gray-500 hover:text-white transition-colors">›</button>
                        </div>
                                ...
                                <div key={date} className="flex justify-center items-center">
                                    <button
                                        ...
                                        className={clsx(
                                            ...
                                            date === 2 ? "bg-[#E12E2E] text-white font-bold shadow-[0_0_20px_rgba(225,46,46,0.3)]" : "text-gray-400 hover:bg-white/10"
                                        )}
                                    >
                                        {date}
                                    </button>
            ...
            <div className="mb-6">
                <h2 className="text-gray-400 text-sm font-light">
                    {activeTab === 'today' ? (
                        <>2 лютого, <span className="text-gray-500">понеділок</span></>
                    ) : (
                        <>3 лютого, <span className="text-gray-500">вівторок</span></>
                    )}
                </h2>
            </div>
